        ...
        <div class="white-box">
            ...
            <form id="register-form" class="form-horizontal form-material" action='' method="POST">
                <div style="text-align: center;">
                    <h1 style="font-family: 'sensations'; font-size: 100px;">Weddingo</h1>
                    <h3 class="box-title m-t-40 m-b-0">הירשם כעת והצטרף למשפחת וודינגו</h3>
                </div>
                ...
                <div class="form-group m-b-0">
                    <div class="col-sm-12 text-center">
                        <p>יש ברשותך משתמש? <a href="login" class="text-primary m-l-5"><b>אנא התחבר כעת</b></a></p>
                    </div>
                </div>
            </form>
        </div>
