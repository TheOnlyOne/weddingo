            ...
            <div class="container">
                <div class="header-inner">
                    <div class="header-logo">
                        <a href="index-2.html">
                            <img src="{{ URL::asset('templates/superlist/assets/img/logo.png') }}" alt="Logo">
                            <span>Superlist</span>
                        </a>
                    </div><!-- /.header-logo -->
        ...
        <div class="main-inner">
            <div class="content">
                <div class="mt-80 mb80">
                    <div class="detail-banner" style="background-image: url({{ URL::asset('templates/superlist/assets/img/tmp/detail-banner-1.jpg') }});">
                        <div class="container">
                        ...
                        <div class="col-sm-7">
                            <div class="detail-gallery">
                                <div class="detail-gallery-preview">
                                    <a href="{{ URL::asset('templates/superlist/assets/img/tmp/gallery-1.jpg') }}">
                                        <img src="{{ URL::asset('templates/superlist/assets/img/tmp/gallery-1.jpg') }}">
                                    </a>
                                </div>

                                <ul class="detail-gallery-index">
                                    <li class="detail-gallery-list-item active">
                                        <a data-target="{{ URL::asset('templates/superlist/assets/img/tmp/gallery-1.jpg') }}">
                                            <img src="{{ URL::asset('templates/superlist/assets/img/tmp/gallery-1.jpg') }}" alt="...">
                                        </a>
                                    </li>
                                    <li class="detail-gallery-list-item active">
                                        <a data-target="{{ URL::asset('templates/superlist/assets/img/tmp/gallery-2.jpg') }}">
                                            <img src="{{ URL::asset('templates/superlist/assets/img/tmp/gallery-2.jpg') }}" alt="...">
                                        </a>
                                    </li>
                                    <li class="detail-gallery-list-item active">
                                        <a data-target="{{ URL::asset('templates/superlist/assets/img/tmp/gallery-3.jpg') }}">
                                            <img src="{{ URL::asset('templates/superlist/assets/img/tmp/gallery-3.jpg') }}" alt="...">
                                        </a>
                                    </li>
                                    <li class="detail-gallery-list-item active">
                                        <a data-target="{{ URL::asset('templates/superlist/assets/img/tmp/gallery-4.jpg') }}">
                                            <img src="{{ URL::asset('templates/superlist/assets/img/tmp/gallery-4.jpg') }}" alt="...">
                                        </a>
                                    </li>
                                    <li class="detail-gallery-list-item active">
                                        <a data-target="{{ URL::asset('templates/superlist/assets/img/tmp/gallery-5.jpg') }}">
                                            <img src="{{ URL::asset('templates/superlist/assets/img/tmp/gallery-5.jpg') }}" alt="...">
                                        </a>
                                    </li>
                                    <li class="detail-gallery-list-item active">
                                        <a data-target="{{ URL::asset('templates/superlist/assets/img/tmp/gallery-6.jpg') }}">
                                            <img src="{{ URL::asset('templates/superlist/assets/img/tmp/gallery-6.jpg') }}" alt="...">
                                        </a>
                                    </li>
                                    <li class="detail-gallery-list-item active">
                                        <a data-target="{{ URL::asset('templates/superlist/assets/img/tmp/gallery-7.jpg') }}">
                                            <img src="{{ URL::asset('templates/superlist/assets/img/tmp/gallery-7.jpg') }}" alt="...">
                                        </a>
                                    </li>
                                    <li class="detail-gallery-list-item active">
                                        <a data-target="{{ URL::asset('templates/superlist/assets/img/tmp/gallery-8.jpg') }}">
                                            <img src="{{ URL::asset('templates/superlist/assets/img/tmp/gallery-8.jpg') }}" alt="...">
                                        </a>
                                    </li>
                                </ul>
                            </div><!-- /.detail-gallery -->
                            ...
                            <div class="background-white p20">
                                <div class="detail-vcard">
                                    <div class="detail-logo">
                                        <img src="{{ URL::asset('templates/superlist/assets/img/tmp/pragmaticmates-logo.png') }}">
                                    </div><!-- /.detail-logo -->
