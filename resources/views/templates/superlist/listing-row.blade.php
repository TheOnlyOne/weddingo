...
<head>
    ...
    <title>Superlist - Row Version</title>
</head>
                    ...
                    <div class="cards-row">
                        ...
                        <div class="card-row">
                            <div class="card-row-inner">
                                <div class="card-row-image" data-background-image="{{ URL::asset('templates/superlist/assets/img/tmp/product-1.jpg') }}">
                        ...
                        <div class="card-row">
                            <div class="card-row-inner">
                                <div class="card-row-image" data-background-image="{{ URL::asset('templates/superlist/assets/img/tmp/product-2.jpg') }}">
                        ...
                        <div class="card-row">
                            <div class="card-row-inner">
                                <div class="card-row-image" data-background-image="{{ URL::asset('templates/superlist/assets/img/tmp/product-3.jpg') }}">
                        ...
                        <div class="card-row">
                            <div class="card-row-inner">
                                <div class="card-row-image" data-background-image="{{ URL::asset('templates/superlist/assets/img/tmp/product-4.jpg') }}">
                        ...
                        <div class="card-row">
                            <div class="card-row-inner">
                                <div class="card-row-image" data-background-image="{{ URL::asset('templates/superlist/assets/img/tmp/product-5.jpg') }}">
                                    <div class="card-row-label"><a href="listing-detail.html">Vacation</a></div><!-- /.card-row-label -->
                        ...
                        <div class="card-row">
                            <div class="card-row-inner">
                                <div class="card-row-image" data-background-image="{{ URL::asset('templates/superlist/assets/img/tmp/product-6.jpg') }}">
                                    <div class="card-row-label"><a href="listing-detail.html">Restaurant</a></div><!-- /.card-row-label -->
                        ...
                        <div class="card-row">
                            <div class="card-row-inner">
                                <div class="card-row-image" data-background-image="{{ URL::asset('templates/superlist/assets/img/tmp/product-7.jpg') }}">
                        ...
                        <div class="card-row">
                            <div class="card-row-inner">
                                <div class="card-row-image" data-background-image="{{ URL::asset('templates/superlist/assets/img/tmp/product-8.jpg') }}">
                        ...
                        <div class="card-row">
                            <div class="card-row-inner">
                                <div class="card-row-image" data-background-image="{{ URL::asset('templates/superlist/assets/img/tmp/product-9.jpg') }}">
                        ...
                        <div class="card-row">
                            <div class="card-row-inner">
                                <div class="card-row-image" data-background-image="{{ URL::asset('templates/superlist/assets/img/tmp/product-10.jpg') }}">
                        ...
                        <div class="card-row">
                            <div class="card-row-inner">
                                <div class="card-row-image" data-background-image="{{ URL::asset('templates/superlist/assets/img/tmp/product-11.jpg') }}">
                                    <div class="card-row-label"><a href="listing-detail.html">Food</a></div><!-- /.card-row-label -->
                        ...
                        <div class="card-row">
                            <div class="card-row-inner">
                                <div class="card-row-image" data-background-image="{{ URL::asset('templates/superlist/assets/img/tmp/product-12.jpg') }}">
