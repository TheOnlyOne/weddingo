...
<section id="wrapper" class="error-page">
    <div class="error-box">
        <div class="error-body text-center">
            <h1>500</h1>
            <h3 class="text-uppercase">העמוד שביקשת נמצא כרגע בשגיאה ואיננו יכולים להציגו. אנא נסה שנית מאוחר יותר</h3>
            <p class="text-muted m-t-30 m-b-30">לא הצלחנו למצוא את הדף שאליו ניסית לגשת, אנא נסה במועד מאוחי יותר</p>
