    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse slimscrollsidebar">
            <ul class="nav" id="side-menu">
                ...
                <li class="user-pro" style="text-align: center; font-weight: bold; font-size: 16px;">
                </li>
                ...
                <li> <a href="javascript:void(0);" class="waves-effect"><i class="ti-check-box fa-fw text-danger" data-icon="7"></i> <span class="hide-menu text-danger"> המשימות שלי <span class="fa arrow"></span> <span class="label label-rouded label-danger pull-right">בקרוב</span></span></a></li>
