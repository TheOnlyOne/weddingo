...
class VerifyCsrfToken extends BaseVerifier
{
    ...
    protected $except = [
        ...
        'test_ajax',
        'master-client/validate-add-guest',
        'master-client/validate-add-category',
        'master-client/update-template-element',
        'master-client/testSendSMS',
        'master-client/sendSmsGuest',
        'master-client/updateUserTemplate',
        'confirmGuestAttending',
        'master-client/get_wedding_categories',
    ];
}
